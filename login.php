...
<body class="body1">
    ...
    <div class="container" style="margin-left: 50px; width: 60%; margin-top: 80px;">
        <div class="row my-5">
            <div class="col-md-6 text-center login" style="background-image: url('img/don.jpg'); width: 350px; height: 400px; border-radius: 10px; background-size: cover; background-repeat: no-repeat; background-position: center; background-attachment: fixed;">
                ...
                <form action="" method="post" style="margin-top: 20px; margin-left: -120px; margin-right: -120px;">
                    ...
                    <button class="btn btn-primary text-uppercase" type="submit" name="login" style="margin-top: 40px; margin-left: 100px; border-radius: 5px; ">Login</button>
                    <br>
                    <a href="ap.php" class="btn btn-primary" style="margin-top: -65px; margin-left: -100px;"><i class="bi bi-person-plus-fill"></i>Kembali</a>
                </form>
            </div>
        </div>
    </div>
